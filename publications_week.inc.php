<?php
 /**
  * @file publications_week.inc.php
...
//    $this->epanther = $u;
    ...
    $ch = curl_init('https://www.digitalmeasures.com/login/service/v4/UserSchema/INDIVIDUAL-ACTIVITIES-' . $config['key'] . '/INTELLCONT/?startDate=' . $start->format("Y-m-d") . '&endDate=' . $end->format("Y-m-d"));
